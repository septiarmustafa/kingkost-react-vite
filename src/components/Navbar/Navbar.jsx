                ...
                <nav className="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                    <Link to="/" className="navbar-brand p-0">
                        <p className="m-0" style={{
                            ...
                            <img src={logo} alt="KingKos Logo" className="logo-image"
                    ...
                    <div className="collapse navbar-collapse" id="navbarCollapse">
                        <div className="navbar-nav ms-auto py-0">
                            ...
                            <div className="nav-item dropdown">
                                <Link to="#" className="nav-link dropdown-toggle" data-bs-toggle="dropdown">Looking For
                                    ? </Link>
                                <div className="dropdown-menu m-0">
                                    <NavLink to="/kosan" className="dropdown-item"
                                             activeClassName="active">Kos</NavLink>
                                    <Link to="/booking" className="dropdown-item"
                                          activeClassName="active">Booking</Link>
                                    <Link to="/testimonial" className="dropdown-item"
                                          activeClassName="active">Testimonial</Link>
                                </div>
                            </div>
                            ...
                            <NavLink to="/TermsAndConditions" className="nav-item nav-link" activeClassName="active">Terms
                                And Conditions</NavLink>
                        </div>
                        {isAuthenticated ? (
                            <Dropdown>
                                <Dropdown.Toggle variant="secondary" style={{borderRadius: '5px'}} id="dropdown-basic"
                                                 className="text-black fw-bold">
                                    <img src={UserData && UserData.url ? UserData.url : defaultUserImg} alt="User"
                                         style={{
                                             width: '30px',
                                             height: '30px',
                                             marginRight: '8px',
                                ...
                                <Dropdown.Menu>
                                    ...
                                    {role === 'ROLE_CUSTOMER' && ( // Memeriksa jika rolenya adalah ROLE_SELLER
                                        <>
                                            ...
                                            <Dropdown.Divider/>
                                            <Dropdown.Item className="text-black">
                                                <NavLink to="/myBooking" className="dropdown-item"
                                                         activeClassName="active">My Booking</NavLink>
                                            </Dropdown.Item>
                                            <Dropdown.Divider/>
                                        </>
                                    )}
                            ...
                            <>
                                <Link to="/login">
                                    <button className="btn btn-warning mt1"
                                ...
                                <Link to="/register">
                                    <button className="ms-2 btn btn-warning mt1"
                                            style={{borderRadius: '10px', color: 'black', fontWeight: 'bold'}}
                                            type="submit">
                                        REGISTER
                                    </button>
                    ...
                    <div className="container">
                        <div className="row justify-content-center py-5">
                            <div className="col-lg-10 pt-lg-5 mt-lg-5 text-center p-5">
                                <h2 className="display-3 text-white mb-4 animated slideInDown">Find Your Ideal
                                    Kosan</h2>
                                <h2 className="text-white mb-4 animated slideInDown">With Kingkos App</h2>
                                <h3 className=" text-white mb-3 animated slideInDown">Discover Comfortable and
                                    Affordable Kosan Options</h3>
                                <p className="fs-4 text-white mb-4 animated slideInDown">Explore a variety of kosan
                                    options tailored for you.</p>
